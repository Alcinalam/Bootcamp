...
public class DemoStream {
    public static void main(String[] args) {
        ...
        List<Integer> result3 =
                integers.stream().filter(e -> e % 2 == 1 && e > 100) //
                        .collect(Collectors.toList());
        ...
        List<Customer> customers = new LinkedList<>(List
                .of(new Customer(13, "Jenny"), new Customer(19, "Vincent")));
        ...
        customers.get(1).SetAge(20); // updating customers -> adultCustomers has been updated.(both list updated)
        ...
        Arrays.asList(strings); // fixed size list -> do not support add/remove
