...
public class DemoStream2 {
  ...
  public static void main(String[] args) {
    ...
    List<Customer> customers = new LinkedList<>(
        List.of(new Customer(12, "ken"), new Customer(3, "Ben"),
            new Customer(8, "Tom"), new Customer(17, "Tom")));
    ...
    // because map() is intermiate operations, the map function will not be executed until terminal operation
