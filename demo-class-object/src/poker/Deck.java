...
public class Deck {
  ...
  public static final int[] RANKS =
      new int[] {Card.ONE, Card.TWO, Card.THREE, Card.FOUR, Card.FIVE,Card.SIX,Card.SEVEN,Card.NINE,
  ...
  public static void main(String[] args) {
    ...
    Suit x = Suit.SPADE;
    System.out.println(x != Suit.CLUB);
    System.out.println(x == Suit.SPADE);
    if (x == Suit.HEART) {
