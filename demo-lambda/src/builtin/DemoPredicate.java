...
public class DemoPredicate {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(isCharacterS.test("SOS", 1)); // false
    System.out.println(isCharacterS.test("SOS", 0)); // true
    ...
    System.out.println("combined=" + combined.test("hello","lo")); //false
    System.out.println("combined=" + combined.test("lollo", "lo")); //true

    BiPredicate<String, String> combined2 = startsWith.or(endsWith);
    System.out.println("combine2" + combined2.test("hello","lo")); //true
    System.out.println("combine2" + combined2.test("lollo", "lo")); //true
