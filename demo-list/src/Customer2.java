...
public class Customer2 {
  ...
  public static void main(String[] args) {
    ...
    // ss object reference can only point to the mehtods that comply with List interface
    ss.add("hello");
    ss.remove(0);
    ss.add("abc");
    ...
    System.out.println(new ArrayList<>(List.of("Vincent")).contains("Vincent")); // true, performace low (loop)
